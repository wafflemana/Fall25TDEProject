...
# Paths
data_dir = r"C:\Users\Aviyel\PycharmProjects\Fall25TDEProject\models\m7a0.9_M22\Spectra_150-450"
...
for spec_path in spec_files:
    ...
    #save pngs
    save_path = os.path.join(save_dir, f"{spec_number}lumiplot.png")
