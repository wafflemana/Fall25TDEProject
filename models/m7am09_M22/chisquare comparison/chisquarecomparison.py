...
#directories
spec_path = r"C:\Users\Aviyel\PycharmProjects\Fall25TDEProject\models\m7am09_M22\3D\Spectra_150+"
chisquare_path = r"C:\Users\Aviyel\PycharmProjects\Fall25TDEProject\models\chisquaretest\chisquareresults\chisquare_results.csv"
...
#observered data
spec_file = r"C:\Users\Aviyel\PycharmProjects\Fall25TDEProject\models\m7am09_M22\3D\Spectra_150+\spec0150.dat"
...
chisquare_rrr_optuv = chisquare_data.iloc[0,1]
chisquare_ttt_optuv = chisquare_data.iloc[0,2]
chisquare_rrr_softxray = chisquare_data.iloc[0,4]
chisquare_ttt_softxray = chisquare_data.iloc[0,5]
...
for band, (lambda_min_cm, lambda_max_cm) in bands.items():
    ...
    nu_max_band = ccc / lambda_min_cm  # smaller λ → higher ν
    nu_min_band = ccc / lambda_max_cm  # larger λ → lower ν
